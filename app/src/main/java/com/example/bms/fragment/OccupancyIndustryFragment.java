...
public class OccupancyIndustryFragment extends Fragment {
    ...
    //url
    private String pageUrl = "http://portal-bams.mncgroup.com:8008/reportoccupancyindustry?token=";
    ...
    public OccupancyIndustryFragment(String token) {
        this.token = token;
    ...
    private void LoadWeb() {
        ...
        wv_OccupancyIndustry.loadUrl(pageUrl+token);
        ...
        wv_OccupancyIndustry.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                //clear cache
                wv_OccupancyIndustry.clearCache(true);
